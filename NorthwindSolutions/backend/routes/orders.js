...
//     await client.connect();
//     let data = req.body;
//     let params = [data.OrderID, data.CustomerID, data.EmployeeID, data.OrderDate, data.RequiredDate, data.ShippedDate, data.ShipVia, data.Freight, data.ShipName, data.ShipAddress, data.ShipCity, data.ShipRegion, data.ShipPostalCode, data.ShipCountry, req.params.id];
//     let result = await client.query('update orders set "OrderID", "CustomerID"=$1, "EmployeeID"=$2, "OrderDate"=$3, "RequiredDate"=$4, "ShippedDate"=$5, "ShipVia"=$6, "Freight"=$7, "ShipName"=$8, "ShipAddress"=$9, "ShipCity"=$10, "ShipRegion"=$11, "ShipPostalCode"=$12, "ShipCountry"=$13 where "OrderID"=$14', params)
//     res,json(result.rows[0]);
//     await client.end();
// })
